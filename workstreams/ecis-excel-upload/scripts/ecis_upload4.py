...
with sync_playwright() as p:
    ...
    page.screenshot(path=str(OUT / "upload4_widget.png"), full_page=True)
    ...
    time.sleep(3)
    page.screenshot(path=str(OUT / "upload4_after_upload.png"), full_page=True)
    page.click('[id="buttongo:form:B"]')
    page.wait_for_load_state("networkidle", timeout=20000)
    time.sleep(2.5)
    page.screenshot(path=str(OUT / "upload4_after_go.png"), full_page=True)
    browser.close()
