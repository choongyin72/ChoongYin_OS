...
begin
  ...
  UPDATE OV_IMP_SOURCE_PATH SET SOURCE_PATH = 'Move', PATH_PARAM_1 = '0', PATH_PARAM_2 = '1', REV_TEXT = v_rev
   WHERE IMP_SOURCE_INTERFACE_CODE = v_code AND IMP_SOURCE_MAPPING_CODE = 'WELL' AND SOURCE_TYPE = 'UPPER_LEFT' AND SORT_ORDER = 10;
  IF SQL%ROWCOUNT = 0 THEN
  ...
  UPDATE OV_IMP_SOURCE_PATH SET SOURCE_PATH = 'FindVertical', PATH_PARAM_1 = '""', PATH_PARAM_2 = null, REV_TEXT = v_rev
   WHERE IMP_SOURCE_INTERFACE_CODE = v_code AND IMP_SOURCE_MAPPING_CODE = 'WELL' AND SOURCE_TYPE = 'LOWER_RIGHT' AND SORT_ORDER = 20;
  IF SQL%ROWCOUNT = 0 THEN
    INSERT INTO OV_IMP_SOURCE_PATH (OBJECT_START_DATE, SORT_ORDER, SOURCE_TYPE, SOURCE_PATH, PATH_PARAM_1,
  ...
  UPDATE OV_IMP_SOURCE_PATH SET SOURCE_PATH = 'Move', PATH_PARAM_1 = '1', PATH_PARAM_2 = '1', REV_TEXT = v_rev
   WHERE IMP_SOURCE_INTERFACE_CODE = v_code AND IMP_SOURCE_MAPPING_CODE = 'DATE' AND SOURCE_TYPE = 'UPPER_LEFT' AND SORT_ORDER = 10;
  IF SQL%ROWCOUNT = 0 THEN
    INSERT INTO OV_IMP_SOURCE_PATH (OBJECT_START_DATE, SORT_ORDER, SOURCE_TYPE, SOURCE_PATH, PATH_PARAM_1,
           PATH_PARAM_2, IMP_SOURCE_MAPPING_ID, REV_TEXT)
  ...
  END IF;
  UPDATE OV_IMP_SOURCE_PATH SET SOURCE_PATH = 'FindVertical', PATH_PARAM_1 = '""', PATH_PARAM_2 = null, REV_TEXT = v_rev
   WHERE IMP_SOURCE_INTERFACE_CODE = v_code AND IMP_SOURCE_MAPPING_CODE = 'DATE' AND SOURCE_TYPE = 'LOWER_RIGHT' AND SORT_ORDER = 20;
  IF SQL%ROWCOUNT = 0 THEN
    INSERT INTO OV_IMP_SOURCE_PATH (OBJECT_START_DATE, SORT_ORDER, SOURCE_TYPE, SOURCE_PATH, PATH_PARAM_1,
           IMP_SOURCE_MAPPING_ID, REV_TEXT)
    VALUES (v_sd, 20, 'LOWER_RIGHT', 'FindVertical', '""',
  ...
  UPDATE OV_IMP_SOURCE_PATH SET SOURCE_PATH = 'Move', PATH_PARAM_1 = '2', PATH_PARAM_2 = '1', REV_TEXT = v_rev
   WHERE IMP_SOURCE_INTERFACE_CODE = v_code AND IMP_SOURCE_MAPPING_CODE = 'PRESSURE' AND SOURCE_TYPE = 'UPPER_LEFT' AND SORT_ORDER = 10;
  IF SQL%ROWCOUNT = 0 THEN
    INSERT INTO OV_IMP_SOURCE_PATH (OBJECT_START_DATE, SORT_ORDER, SOURCE_TYPE, SOURCE_PATH, PATH_PARAM_1,
           PATH_PARAM_2, IMP_SOURCE_MAPPING_ID, REV_TEXT)
  ...
  END IF;
  UPDATE OV_IMP_SOURCE_PATH SET SOURCE_PATH = 'FindVertical', PATH_PARAM_1 = '""', PATH_PARAM_2 = null, REV_TEXT = v_rev
   WHERE IMP_SOURCE_INTERFACE_CODE = v_code AND IMP_SOURCE_MAPPING_CODE = 'PRESSURE' AND SOURCE_TYPE = 'LOWER_RIGHT' AND SORT_ORDER = 20;
  IF SQL%ROWCOUNT = 0 THEN
    INSERT INTO OV_IMP_SOURCE_PATH (OBJECT_START_DATE, SORT_ORDER, SOURCE_TYPE, SOURCE_PATH, PATH_PARAM_1,
           IMP_SOURCE_MAPPING_ID, REV_TEXT)
    VALUES (v_sd, 20, 'LOWER_RIGHT', 'FindVertical', '""',
