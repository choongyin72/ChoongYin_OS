*** Settings ***
Documentation       EC IUD Test - Well Hole (Configuration > Assets > Well and Reservoir Objects).
...
...                 a unique AUTOTEST_WELL_HOLE_<timestamp> code is generated per run.

Resource            ../../../../pageobjects/Configuration/Assets/Well and Reservoir Objects/well_hole_page.resource
...
Set Up Well Hole Suite
    ...
    Prepare IUD Object Data    AUTOTEST_WELL_HOLE_    Well Hole
