...
| Calendar | Date Objects | ✅ DONE (2026-08-23, Batch 6) | #449 (pending) |
...
(final batch) in progress — Calendar done (this PR); Calendar Collection and
Account Mapping being converted in parallel by sibling agents.
