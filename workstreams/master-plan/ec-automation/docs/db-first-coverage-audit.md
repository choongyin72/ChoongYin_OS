...
**Summary:** 73 classes total - 4 Yes (2 shipped, 2 found-but-complex) - 2 No (both label collisions) - 67 Unclear (need manual title investigation, same method as the 2 shipped screens)
...
| COST_MAPPING | Data Mapping | VERSIONED | COST_MAPPING | 2 | Unclear | Related screens found, no exact-label match: Project Data Mapping; Project Data Mapping Accrual; Project Data Mapping Setup - needs manual title investigation |
| COST_MAPPING_NAV | Data Mapping | VERSIONED | COST_MAPPING | 2 | Unclear | Related screens found, no exact-label match: Project Data Mapping; Project Data Mapping Accrual; Project Data Mapping Setup - needs manual title investigation |
...
| FINANCIAL_ITEM | Financial Item | VERSIONED | FINANCIAL_ITEM | 23 | Unclear | Related screens found, no exact-label match: Daily Financial Item; Daily Financial Item Calculation; Financial Item Definition; Financial Item Template; Monthly Financial Item - needs manual title investigation |
