...
Regulatory Permits) plus Licence (batch-3) landed. Every screen already rebuilt
to the Bank-pattern T2-consolidated shape now has the explicit filter wiring.
