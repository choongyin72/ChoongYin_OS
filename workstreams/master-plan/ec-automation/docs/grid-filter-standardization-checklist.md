...
**26 of 26 done.** All 5 batch-2 screens (Country, County, Currency, VAT Code,
Regulatory Permits), all 5 batch-3 screens (Field Group, Customer, Operator
Lease, MMS Lease, Licence), and Vendor + State Lease (batch-4, 2 of 5 landed
so far) are in. Every screen already rebuilt to the Bank-pattern
