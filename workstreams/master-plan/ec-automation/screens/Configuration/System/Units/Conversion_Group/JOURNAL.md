# JOURNAL - Conversion Group (CO.1049) OV IUD

## 2026-07-26
- **Branch:** `feature/conversion_group-iud` (own branch, stacked so the shared-engine helpers are present).
...
- **Recon** (`investigation/recon.py`, read-only): DB `CLASS_TYPE=OBJECT` ⇒ OV; treeview
  Configuration > System > Units > Conversion Group. Mandatory Code/Name/Start Date; optional dropdowns skipped.
