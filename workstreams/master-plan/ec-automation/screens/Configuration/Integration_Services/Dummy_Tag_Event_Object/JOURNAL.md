# JOURNAL - Dummy Tag Event Object (CO.1063) OV IUD

## 2026-07-26
- **Branch:** `feature/dummy_tag_event_object-iud` (own branch, stacked so the shared-engine helpers are present).
...
- **Recon** (`investigation/recon.py`, read-only): DB `CLASS_TYPE=OBJECT` ⇒ OV; treeview
  Configuration > Integration_Services > Dummy Tag Event Object. Mandatory Code/Name/Start Date; optional dropdowns skipped.
