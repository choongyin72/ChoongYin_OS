# JOURNAL - EC Code Object (CD.0135) OV IUD

## 2026-07-26
- **Branch:** `feature/ec_code_object-iud` (own branch, stacked so the shared-engine helpers are present).
...
- **Recon** (`investigation/recon.py`, read-only): DB `CLASS_TYPE=OBJECT` ⇒ OV; treeview
  Configuration > Codes > EC Code Object. Mandatory Code/Name/Start Date; optional dropdowns skipped.
