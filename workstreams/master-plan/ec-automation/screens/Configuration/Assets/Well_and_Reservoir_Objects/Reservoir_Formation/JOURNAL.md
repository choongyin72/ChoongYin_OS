...
## 2026-07-26
- **Branch:** `feature/reservoir_formation-iud` (own branch, stacked so the shared-engine helpers are present).
...
- **Recon** (`investigation/recon.py`, read-only): DB `CLASS_TYPE=OBJECT` ⇒ OV; treeview
  Configuration > Assets > Well_and_Reservoir_Objects > Reservoir Formation. Mandatory Code/Name/Start Date; optional dropdowns skipped.
