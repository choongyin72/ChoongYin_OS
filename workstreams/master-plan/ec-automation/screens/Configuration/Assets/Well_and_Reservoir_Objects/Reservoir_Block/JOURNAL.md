# JOURNAL - Reservoir Block (CO.0133) OV IUD
...
- **Recon** (`investigation/recon.py`, read-only): DB `CLASS_TYPE=OBJECT` ⇒ OV; treeview
  Configuration > Assets > Well_and_Reservoir_Objects > Reservoir Block. Mandatory Code/Name/Start Date; optional dropdowns skipped.
