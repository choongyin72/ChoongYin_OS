...
GRID = "manage_object_nav_nav:form:T_data"; CODE = "AUTOTEST_CHK_RECON"
def dump(pg, form):
...
with sync_playwright() as p:
    ...
    ec.login(pg, URL, os.environ.get("EC_USER", "sysadmin"), os.environ.get("EC_PASS", "sysadmin")); ec.open_object_screen(pg, "Choke"); ec.click_go(pg)
    ec.insertObjectRecord(pg, GRID, [
        {"label":"Choke Code","value":CODE,"kind":"text"},
        {"label":"Choke Name","value":"AUTOTEST recon","kind":"text"},
    ...
    print("residual after close:", db.count_like("ov_choke","AUTOTEST"))
    br.close()
