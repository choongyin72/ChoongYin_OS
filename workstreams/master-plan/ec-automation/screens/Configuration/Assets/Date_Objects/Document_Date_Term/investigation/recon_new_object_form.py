"""
READ-ONLY recon: open Document Date Term, click Insert -> New Object, dump every
objectForm field (id, label, mandatory/yellow, control type). Never saves.
Confirms the OV New-Object mandatory set for CD.0107 before building the IUD flow.
"""
