...
## B. RF files
- [x] **8. T3 page object** -- `pageobjects/Configuration/Assets/Date_Objects/calendar_collection_page.resource` (locators in Variables; docstring matches).
- [x] **9. Suite** -- `tests/Configuration/Assets/Date_Objects/calendar_collection_iud.robot` (clean -> insert -> update -> delete -> cleanup).
