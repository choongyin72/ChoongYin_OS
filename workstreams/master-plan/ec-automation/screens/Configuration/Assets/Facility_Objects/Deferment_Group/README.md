# Deferment Group (CO.0149) - OV IUD bundle

Manage-Object (OV) screen: **Configuration > Assets > Facility_Objects > Deferment Group**. Full Insert / Update / Delete
(End Date = Start Date), DB-verified against `OV_DEFERMENT_GROUP`, self-cleaning. Built **label-driven, zero hardcoded
field ids** on the shared engine + T2.

## Artifacts
- **SOW:** `deferment_group_sow.md`
- **Playwright driver:** `../../../py/deferment_group_iud.py` (thin; shared engine + DbVerify)
...
- **investigation/** recon.py - **evidence/** deferment_group_0[1-5]_*.png + rf_report.html
