...
## 2026-07-26
- **Branch:** `feature/deferment_group-iud` (own branch, stacked so the shared-engine helpers are present).
...
- **Recon** (`investigation/recon.py`, read-only): DB `CLASS_TYPE=OBJECT` ⇒ OV; treeview
  Configuration > Assets > Facility_Objects > Deferment Group. Mandatory Code/Name/Start Date; optional dropdowns skipped.
