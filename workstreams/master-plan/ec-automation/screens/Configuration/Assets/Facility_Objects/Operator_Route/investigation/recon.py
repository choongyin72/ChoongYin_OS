"""Operator Route - read-only recon (checklist #5). Opens the screen + dumps the New-Object field
...
with sync_playwright() as p:
    ...
    ec.open_object_screen(pg, 'Operator Route')
    ...
    print("recon: New-Object form opened (read-only, no Save). View = OV_OPERATOR_ROUTE.")
    br.close()
