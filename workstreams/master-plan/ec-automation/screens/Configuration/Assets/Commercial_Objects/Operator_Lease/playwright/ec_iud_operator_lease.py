"""EC IUD - Operator Lease (Playwright reference).
Thin config over the shared engine in screens/.../Basic_Objects/_shared/.
See operator_lease_sow.md for the screen analysis and README.md for run instructions."""
import sys
