"""EC IUD - Customer (Playwright reference).
Thin config over the shared engine in screens/.../Basic_Objects/_shared/.
See customer_sow.md for the screen analysis and README.md for run instructions."""
import sys
...
CFG = {
    ...
    "ins_dd": [],
    "ins_dd_first": ['tab:tabPanel:objectForm:form:G:0:R:22:C:1:dd'],
    "ins_extra": [('tab:tabPanel:objectForm:form:G:0:R:6:C:1:in', 'ERP999', 'text'), ('tab:tabPanel:objectForm:form:G:0:R:7:C:1:in', 'AUTOTEST Official', 'text')],
