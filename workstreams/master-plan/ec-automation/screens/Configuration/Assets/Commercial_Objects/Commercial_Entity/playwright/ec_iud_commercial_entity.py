"""EC IUD - Commercial Entity (Playwright reference).
Thin config over the shared engine in screens/.../Basic_Objects/_shared/.
See commercial_entity_sow.md for the screen analysis and README.md for run instructions."""
import sys
...
CFG = {
    ...
    "ins_dd_first": [],
    "ins_extra": [],
    "upd_code": "tab:tabPanel:updateAttributes:form:G:0:R:2:C:1:in",
    "upd_name": "tab:tabPanel:updateAttributes:form:G:0:R:3:C:1:in",
    "del_end": "tab:tabPanel:objectdates:form:G:0:R:0:C:3:da_input",
    "start_date": "2003-01-01",
    "end_date": "2003-01-01",
    "db_view": "OV_COMMERCIAL_ENTITY",
