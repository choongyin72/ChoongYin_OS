"""EC IUD - Company Contact (Playwright reference).
Thin config over the shared engine in screens/.../Basic_Objects/_shared/.
See company_contact_sow.md for the screen analysis and README.md for run instructions."""
import sys
...
CFG = {
    ...
    "ins_dd": [],
    "ins_dd_first": ['tab:tabPanel:objectForm:form:G:0:R:17:C:1:dd'],
    "ins_extra": [],
