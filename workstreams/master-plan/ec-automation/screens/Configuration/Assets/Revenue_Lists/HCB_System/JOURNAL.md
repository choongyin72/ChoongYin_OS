# JOURNAL - HCB System (CD.0097) OV IUD

## 2026-07-26
- **Branch:** `feature/hcb_system-iud` (own branch, stacked so the shared-engine helpers are present).
...
- **Recon** (`investigation/recon.py`, read-only): DB `CLASS_TYPE=OBJECT` ⇒ OV; treeview
  Configuration > Assets > Revenue_Lists > HCB System. Mandatory Code/Name/Start Date; optional dropdowns skipped.
