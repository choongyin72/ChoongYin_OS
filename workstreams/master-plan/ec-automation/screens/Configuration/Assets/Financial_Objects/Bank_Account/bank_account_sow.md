...
**Date:** 2026-06-11
**Version:** 0.9 — ⚠ PARKED 2026-06-11: Customer dropdown fails to populate inside the full insert flow (works standalone) - re-render interference; timeboxed and parked
...
### Test data
Code `AUTOTEST_BACC_<timestamp>` | Name `Bank Account <code>` (+` UPD`) | Start=End `2000-01-01`
