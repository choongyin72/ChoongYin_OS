"""EC IUD - Payment Scheme (Playwright reference).
Thin config over the shared engine in screens/.../Basic_Objects/_shared/.
See payment_scheme_sow.md for the screen analysis and README.md for run instructions."""
import sys
