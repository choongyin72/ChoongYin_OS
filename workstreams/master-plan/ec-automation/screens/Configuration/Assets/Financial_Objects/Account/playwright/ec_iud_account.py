"""EC IUD - Account (Playwright reference).
Thin config over the shared engine in screens/.../Basic_Objects/_shared/.
See account_sow.md for the screen analysis and README.md for run instructions."""
import sys
...
CFG = {
    ...
    "ins_dd": [],
    "ins_dd_first": ['tab:tabPanel:objectForm:form:G:0:R:7:C:1:dd'],
    "ins_extra": [('tab:tabPanel:objectForm:form:G:0:R:8:C:1:in', '999999', 'text')],
