"""EC IUD - Revenue Order (Playwright reference).
Thin config over the shared engine in screens/.../Basic_Objects/_shared/.
See revenue_order_sow.md for the screen analysis and README.md for run instructions."""
import sys
