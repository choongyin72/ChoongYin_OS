"""EC IUD - Product Description (Playwright reference).
Thin config over the shared engine in screens/.../Basic_Objects/_shared/.
See product_description_sow.md for the screen analysis and README.md for run instructions."""
import sys
...
CFG = {
    ...
    "ins_dd": [],
    "ins_dd_first": ['tab:tabPanel:objectForm:form:G:0:R:5:C:1:dd', 'tab:tabPanel:objectForm:form:G:0:R:6:C:1:dd', 'tab:tabPanel:objectForm:form:G:0:R:7:C:1:dd'],
    "ins_extra": [],
