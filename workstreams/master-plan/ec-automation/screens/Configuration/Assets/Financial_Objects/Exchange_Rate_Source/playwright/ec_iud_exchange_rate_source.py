"""EC IUD - Exchange Rate Source (Playwright reference).
Thin config over the shared engine in screens/.../Basic_Objects/_shared/.
See exchange_rate_source_sow.md for the screen analysis and README.md for run instructions."""
import sys
