"""EC IUD - Currency (Playwright reference).
Thin config over the shared engine in screens/.../Basic_Objects/_shared/.
See currency_sow.md for the screen analysis and README.md for run instructions."""
import sys
...
CFG = {
    ...
    "ins_dd": [],
    "ins_dd_first": [],
    "ins_extra": [('tab:tabPanel:objectForm:form:G:0:R:6:C:1:cb', 'on', 'checkbox')],
