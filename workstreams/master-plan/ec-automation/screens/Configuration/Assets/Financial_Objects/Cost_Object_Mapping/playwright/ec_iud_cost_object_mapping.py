"""EC IUD - Cost Object Mapping (Playwright reference).
Thin config over the shared engine in screens/.../Basic_Objects/_shared/.
See cost_object_mapping_sow.md for the screen analysis and README.md for run instructions."""
import sys
...
CFG = {
    "slug": "cost_object_mapping",
    "label": "Cost Object Mapping",
    "code_prefix": "COM",
    ...
    "ins_dd": [],
    "ins_dd_first": ['tab:tabPanel:objectForm:form:G:0:R:6:C:1:dd', 'tab:tabPanel:objectForm:form:G:0:R:9:C:1:dd', 'tab:tabPanel:objectForm:form:G:0:R:12:C:1:dd', 'tab:tabPanel:objectForm:form:G:0:R:7:C:1:dd'],
    "ins_extra": [],
