...
## 1. REQUIREMENT
Automate IUD on the **Cost Object Mapping** screen with DB-level proof. Constraints: NEVER touch
existing data; test codes `AUTOTEST_COM_<timestamp>`; local sandbox, user sysadmin.
...
|---|---|
| Object Type (reference dropdown, banner-discovered) | first available option |
| Company (reference dropdown, banner-discovered) | first available option |
| Distribution Object Type (reference dropdown, banner-discovered) | first available option |
| Cost Object (reference dropdown, banner-discovered) | first available option |
...
## 5. DELIVERABLES
RF suite + page object under `tests|pageobjects/.../Financial_Objects/cost_object_mapping_*`,
