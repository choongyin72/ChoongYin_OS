...
## A. Bundle artifacts
- [x] 1 `split_item_other_sow.md` - [x] 2 `README.md` - [x] 3 `JOURNAL.md`
- [x] 4 Playwright flow -> `py/split_item_other_iud.py` (py/ per owner rule; env-creds, ASCII)
- [x] 5 `investigation/` (recon.py) - [x] 6 `evidence/` (split_item_other_0[1-5]_*.png + rf_report.html) - [x] 7 `CHECKLIST.md`

## B. RF files
- [x] 8 T3 `pageobjects/Configuration/Assets/Revenue_Split_Keys/split_item_other_page.resource` (label-driven, NO hardcoded ids)
...
- [x] 13 DB ground-truth - `Code Should Be Present/Absent In View OV_SPLIT_ITEM_OTHER` + `Field Should Equal In View OV_SPLIT_ITEM_OTHER <code> NAME` (update)
...
## E. Knowledge base
- [x] 20 KB map `ec-ui-knowledge/screens/split_item_other.md`
