"""Chemical Stream - read-only recon (checklist #5). Opens the screen + dumps the New-Object field
...
with sync_playwright() as p:
    ...
    print("recon: New-Object form opened (read-only, no Save). View = OV_CHEM_STREAM.")
    br.close()
