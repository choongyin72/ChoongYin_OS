"""Reservoir Formation - IUD driver (thin). Reuses the shared engine py/ec_object_iud.py + DbVerify.py.

OV (Well and Reservoir Objects, CO.0135). Mandatory: Reservoir Formation Code/Reservoir Formation Name/Start Date
(optional dropdowns skipped). Update = Name. Selector map: ec-ui-knowledge/screens/reservoir_formation.md.
Run headed: EC_HEADED=1 py -X utf8 workstreams/master-plan/ec-automation/py/reservoir_formation_iud.py
"""
import os
import sys
...
VIEW          = "ov_resv_formation"
CODE          = os.environ.get("EC_CODE", "AUTOTEST_RESVF_001")
START_DATE    = "2000-01-01"
END_DATE      = START_DATE
NAME          = "AUTOTEST Reservoir Formation 001"
NAME_UPD      = "AUTOTEST Reservoir Formation 001 UPDATED"

INSERT_FIELDS = [
    {"label": "Reservoir Formation Code",  "value": CODE,       "kind": "text"},
    {"label": "Reservoir Formation Name",  "value": NAME,       "kind": "text"},
    {"label": "Start Date",  "value": START_DATE, "kind": "date"},
]
UPDATE_FIELDS = [
    {"label": "Reservoir Formation Name",  "value": NAME_UPD,   "kind": "text"},
]
...
EVID = _ROOT / "tmp" / "reservoir_formation" / "evidence"
...
def shot(page, label):
    try:
        page.screenshot(path=str(EVID / f"reservoir_formation_{label}.png"))
    except Exception:
        pass
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            def _v_ins():
                ...
                assert db.code_present(VIEW, CODE), "not in ov_resv_formation"
