"""Storage Flow - IUD driver (thin). Reuses the shared engine py/ec_object_iud.py + DbVerify.py.

OV (Tank and Storage Objects, CO.2091). Mandatory: Storage Flow Code/Storage Flow Name/Start Date
(optional dropdowns skipped). Update = Name. Selector map: ec-ui-knowledge/screens/storage_flow.md.
Run headed: EC_HEADED=1 py -X utf8 workstreams/master-plan/ec-automation/py/storage_flow_iud.py
"""
import os
import sys
...
VIEW          = "ov_storage_flow"
CODE          = os.environ.get("EC_CODE", "AUTOTEST_SF_001")
START_DATE    = "2000-01-01"
END_DATE      = START_DATE
NAME          = "AUTOTEST Storage Flow 001"
NAME_UPD      = "AUTOTEST Storage Flow 001 UPDATED"

INSERT_FIELDS = [
    {"label": "Storage Flow Code",  "value": CODE,       "kind": "text"},
    {"label": "Storage Flow Name",  "value": NAME,       "kind": "text"},
    {"label": "Start Date",  "value": START_DATE, "kind": "date"},
    {"label": "Flow Direction", "value": "__FIRST__", "kind": "dropdown"},
    {"label": "Storage", "value": "__FIRST__", "kind": "dropdown"},
]
UPDATE_FIELDS = [
    {"label": "Storage Flow Name",  "value": NAME_UPD,   "kind": "text"},
]
...
EVID = _ROOT / "tmp" / "storage_flow" / "evidence"
...
def shot(page, label):
    try:
        page.screenshot(path=str(EVID / f"storage_flow_{label}.png"))
    except Exception:
        pass
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            def _v_ins():
                ...
                assert db.code_present(VIEW, CODE), "not in ov_storage_flow"
