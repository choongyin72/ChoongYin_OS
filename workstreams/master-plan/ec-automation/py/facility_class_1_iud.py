...
VIEW          = 'ov_fcty_class_1'
CODE          = os.environ.get("EC_CODE", "AUTOTEST_FC1_001")
START_DATE    = "2000-01-01"
END_DATE      = START_DATE
NAME          = 'AUTOTEST Facility Class 1 001'
NAME_UPD      = 'AUTOTEST Facility Class 1 001' + " UPDATED"
...
EVID = _ROOT / "tmp" / 'facility_class_1' / "evidence"
...
def shot(page, label):
    try:
        page.screenshot(path=str(EVID / ("fc1_" + label + ".png")))
    except Exception:
        pass
...
def main():
    with sync_playwright() as p:
        ...
        try:
            ...
            insert_fields = [
                {"label": 'Facility Class 1 Code', "value": CODE,       "kind": "text"},
                {"label": 'Facility Class 1 Name', "value": NAME,       "kind": "text"},
                {"label": "Start Date", "value": START_DATE, "kind": "date"},
            ]
            update_fields = [{"label": 'Facility Class 1 Name', "value": NAME_UPD, "kind": "text"}]
