"""EC Code Object - IUD driver (thin). Reuses the shared engine py/ec_object_iud.py + DbVerify.py.

OV (Codes, CD.0135). Mandatory: Object Code/Name/Start Date
(optional dropdowns skipped). Update = Name. Selector map: ec-ui-knowledge/screens/ec_code_object.md.
Run headed: EC_HEADED=1 py -X utf8 workstreams/master-plan/ec-automation/py/ec_code_object_iud.py
"""
import os
import sys
...
VIEW          = "ov_ec_code_object"
CODE          = os.environ.get("EC_CODE", "AUTOTEST_ECO_001")
START_DATE    = "2000-01-01"
END_DATE      = START_DATE
NAME          = "AUTOTEST EC Code Object 001"
NAME_UPD      = "AUTOTEST EC Code Object 001 UPDATED"

INSERT_FIELDS = [
    {"label": "Object Code",  "value": CODE,       "kind": "text"},
    {"label": "Name",  "value": NAME,       "kind": "text"},
    {"label": "Start Date",  "value": START_DATE, "kind": "date"},
    {"label": "EC Code Type", "value": "__FIRST__", "kind": "dropdown"},
    {"label": "EC Code", "value": "__FIRST__", "kind": "dropdown"},
]
UPDATE_FIELDS = [
...
EVID = _ROOT / "tmp" / "ec_code_object" / "evidence"
...
def shot(page, label):
    try:
        page.screenshot(path=str(EVID / f"ec_code_object_{label}.png"))
    except Exception:
        pass
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            def _v_ins():
                ...
                assert db.code_present(VIEW, CODE), "not in ov_ec_code_object"
