"""Chemical Transport Tank - IUD driver (thin). Reuses the shared engine py/ec_object_iud.py + DbVerify.py.

OV (Chemical Objects, CO.0257). Mandatory: Transport Tank Code/Transport Tank Name/Start Date
(optional dropdowns skipped). Update = Name. Selector map: ec-ui-knowledge/screens/chemical_transport_tank.md.
Run headed: EC_HEADED=1 py -X utf8 workstreams/master-plan/ec-automation/py/chemical_transport_tank_iud.py
"""
import os
import sys
...
VIEW          = "ov_chem_trans_tank"
CODE          = os.environ.get("EC_CODE", "AUTOTEST_CTT_001")
START_DATE    = "2000-01-01"
END_DATE      = START_DATE
NAME          = "AUTOTEST Chemical Transport Tank 001"
NAME_UPD      = "AUTOTEST Chemical Transport Tank 001 UPDATED"

INSERT_FIELDS = [
    {"label": "Transport Tank Code",  "value": CODE,       "kind": "text"},
    {"label": "Transport Tank Name",  "value": NAME,       "kind": "text"},
    {"label": "Start Date",  "value": START_DATE, "kind": "date"},
]
UPDATE_FIELDS = [
    {"label": "Transport Tank Name",  "value": NAME_UPD,   "kind": "text"},
]
...
EVID = _ROOT / "tmp" / "chemical_transport_tank" / "evidence"
...
def shot(page, label):
    try:
        page.screenshot(path=str(EVID / f"chemical_transport_tank_{label}.png"))
    except Exception:
        pass
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            def _v_ins():
                ...
                assert db.code_present(VIEW, CODE), "not in ov_chem_trans_tank"
