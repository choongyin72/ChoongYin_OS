"""Dummy Tag Event Object - IUD driver (thin). Reuses the shared engine py/ec_object_iud.py + DbVerify.py.

OV (Integration Services, CO.1063). Mandatory: Dummy Tag Event Object Code/Dummy Tag Event Object Name/Start Date
(optional dropdowns skipped). Update = Name. Selector map: ec-ui-knowledge/screens/dummy_tag_event_object.md.
Run headed: EC_HEADED=1 py -X utf8 workstreams/master-plan/ec-automation/py/dummy_tag_event_object_iud.py
"""
import os
import sys
...
VIEW          = "ov_dummy_tag_event"
CODE          = os.environ.get("EC_CODE", "AUTOTEST_DTE_001")
START_DATE    = "2000-01-01"
END_DATE      = START_DATE
NAME          = "AUTOTEST Dummy Tag Event 001"
NAME_UPD      = "AUTOTEST Dummy Tag Event 001 UPDATED"

INSERT_FIELDS = [
    {"label": "Dummy Tag Event Object Code",  "value": CODE,       "kind": "text"},
    {"label": "Dummy Tag Event Object Name",  "value": NAME,       "kind": "text"},
    {"label": "Start Date",  "value": START_DATE, "kind": "date"},
]
UPDATE_FIELDS = [
    {"label": "Dummy Tag Event Object Name",  "value": NAME_UPD,   "kind": "text"},
]
...
EVID = _ROOT / "tmp" / "dummy_tag_event_object" / "evidence"
...
def shot(page, label):
    try:
        page.screenshot(path=str(EVID / f"dummy_tag_event_object_{label}.png"))
    except Exception:
        pass
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            def _v_ins():
                ...
                assert db.code_present(VIEW, CODE), "not in ov_dummy_tag_event"
