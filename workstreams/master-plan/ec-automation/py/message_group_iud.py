"""Message Group - IUD driver (thin). Reuses shared engine ec_object_iud.py + DbVerify.py.
...
Run headed: EC_HEADED=1 py -X utf8 workstreams/master-plan/ec-automation/py/message_group_iud.py
"""
import os
import sys
...
CODE          = os.environ.get("EC_CODE", "AUTOTEST_MG001")
START_DATE    = "2003-01-01"
END_DATE      = START_DATE
NAME          = 'AUTOTEST Message Group 001'
NAME_UPD      = 'AUTOTEST Message Group 001' + " UPDATED"
...
EVID = _ROOT / "tmp" / 'message_group' / "evidence"
...
def shot(page, label):
    try:
        page.screenshot(path=str(EVID / ("MG_" + label + ".png")))
    except Exception:
        pass
...
def main():
    with sync_playwright() as p:
        ...
        try:
            ...
            insert_fields = [
                {"label": 'Message Group Code', "value": CODE,       "kind": "text"},
