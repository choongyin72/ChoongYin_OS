"""Trailer - IUD driver (thin). Reuses shared engine ec_object_iud.py + DbVerify.py.
...
Run headed: EC_HEADED=1 py -X utf8 workstreams/master-plan/ec-automation/py/trailer_iud.py
"""
import os
import sys
...
SCREEN        = 'Trailer'
GRID_DATA_ID  = "trailer_object:form:T_data"
VIEW          = 'ov_trailer'
CODE          = os.environ.get("EC_CODE", "AUTOTEST_TR_001")
START_DATE    = "2000-01-01"
END_DATE      = START_DATE
NAME          = 'AUTOTEST Trailer 001'
NAME_UPD      = 'AUTOTEST Trailer 001' + " UPDATED"
...
EVID = _ROOT / "tmp" / 'trailer' / "evidence"
...
def shot(page, label):
    try:
        page.screenshot(path=str(EVID / ("tr_" + label + ".png")))
    except Exception:
        pass
...
def main():
    with sync_playwright() as p:
        ...
        try:
            ...
            insert_fields = [
                {"label": 'Trailer Code', "value": CODE,       "kind": "text"},
                {"label": 'Trailer Name', "value": NAME,       "kind": "text"},
                {"label": "Start Date", "value": START_DATE, "kind": "date"},
                {"label": 'Licence Plate No', "value": 'AUTOTEST-TRL-001', "kind": "text"},
                {"label": 'Trailer Type', "value": "__FIRST__", "kind": "dropdown"},
                {"label": 'UOM', "value": "__FIRST__", "kind": "dropdown"},
                {"label": 'Transport Company', "value": "__FIRST__", "kind": "dropdown"},
            ]
            update_fields = [{"label": 'Trailer Name', "value": NAME_UPD, "kind": "text"}]
