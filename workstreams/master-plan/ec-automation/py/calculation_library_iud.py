"""Calculation Library - IUD driver (thin). Reuses the shared engine py/ec_object_iud.py + DbVerify.py.

OV (Calculation Objects, CO.1060). Mandatory: Calc Library Code/Calc Library Name/Start Date
(optional dropdowns skipped). Update = Name. Selector map: ec-ui-knowledge/screens/calculation_library.md.
Run headed: EC_HEADED=1 py -X utf8 workstreams/master-plan/ec-automation/py/calculation_library_iud.py
"""
import os
import sys
...
VIEW          = "ov_calc_library"
CODE          = os.environ.get("EC_CODE", "AUTOTEST_CL_001")
START_DATE    = "2000-01-01"
END_DATE      = START_DATE
NAME          = "AUTOTEST Calc Library 001"
NAME_UPD      = "AUTOTEST Calc Library 001 UPDATED"

INSERT_FIELDS = [
    {"label": "Calc Library Code",  "value": CODE,       "kind": "text"},
    {"label": "Calc Library Name",  "value": NAME,       "kind": "text"},
    {"label": "Start Date",  "value": START_DATE, "kind": "date"},
]
UPDATE_FIELDS = [
    {"label": "Calc Library Name",  "value": NAME_UPD,   "kind": "text"},
]
...
EVID = _ROOT / "tmp" / "calculation_library" / "evidence"
...
def shot(page, label):
    try:
        page.screenshot(path=str(EVID / f"calculation_library_{label}.png"))
    except Exception:
        pass
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            def _v_ins():
                ...
                assert db.code_present(VIEW, CODE), "not in ov_calc_library"
