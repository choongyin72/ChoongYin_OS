"""Choke Model - IUD driver (thin). Reuses the shared engine py/ec_object_iud.py + DbVerify.py.

OV (Stream Objects, CO.0217). Mandatory: Choke Model Code/Name/Start Date (many optional dropdowns skipped).
Update covers Name + Description. Selector map: ec-ui-knowledge/screens/choke_model.md.
Run headed: EC_HEADED=1 py -X utf8 workstreams/master-plan/ec-automation/py/choke_model_iud.py
"""
import os
import sys
...
VIEW          = "ov_choke_model"
CODE          = os.environ.get("EC_CODE", "AUTOTEST_CHKM_001")
START_DATE    = "2000-01-01"
END_DATE      = START_DATE
NAME          = "AUTOTEST Choke Model 001"
NAME_UPD      = "AUTOTEST Choke Model 001 UPDATED"
DESC          = "AUTOTEST desc"
DESC_UPD      = "AUTOTEST desc UPDATED"

INSERT_FIELDS = [
    {"label": "Choke Model Code", "value": CODE,       "kind": "text"},
    {"label": "Choke Model Name", "value": NAME,       "kind": "text"},
    {"label": "Start Date",       "value": START_DATE, "kind": "date"},
]
UPDATE_FIELDS = [
    {"label": "Choke Model Name", "value": NAME_UPD, "kind": "text"},
...
EVID = _ROOT / "tmp" / "choke_model" / "evidence"
...
def shot(page, label):
    try:
        page.screenshot(path=str(EVID / f"chkm_{label}.png"))
    except Exception:
        pass
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            def _v_ins():
                ...
                assert db.code_present(VIEW, CODE), "not in ov_choke_model"
