"""UOP Key - IUD driver (thin). Reuses the shared engine py/ec_object_iud.py + DbVerify.py.

OV (Revenue Lists, CD.0099). Mandatory: Code/Name/Start Date
(optional dropdowns skipped). Update = Name. Selector map: ec-ui-knowledge/screens/uop_key.md.
Run headed: EC_HEADED=1 py -X utf8 workstreams/master-plan/ec-automation/py/uop_key_iud.py
"""
import os
import sys
...
VIEW          = "ov_fin_uop_depr_key"
CODE          = os.environ.get("EC_CODE", "AUTOTEST_UOP_001")
START_DATE    = "2000-01-01"
END_DATE      = START_DATE
NAME          = "AUTOTEST UOP Key 001"
NAME_UPD      = "AUTOTEST UOP Key 001 UPDATED"

INSERT_FIELDS = [
    {"label": "Code",  "value": CODE,       "kind": "text"},
    {"label": "Name",  "value": NAME,       "kind": "text"},
    {"label": "Start Date",  "value": START_DATE, "kind": "date"},
    {"label": "Company", "value": "__FIRST__", "kind": "dropdown"},
    {"label": "Key Type", "value": "__FIRST__", "kind": "dropdown"},
    {"label": "Key Number", "value": "1", "kind": "text"},
]
UPDATE_FIELDS = [
...
EVID = _ROOT / "tmp" / "uop_key" / "evidence"
...
def shot(page, label):
    try:
        page.screenshot(path=str(EVID / f"uop_key_{label}.png"))
    except Exception:
        pass
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            def _v_ins():
                ...
                assert db.code_present(VIEW, CODE), "not in ov_fin_uop_depr_key"
