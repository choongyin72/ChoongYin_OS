    ...
    BEGIN
        UPDATE TV_CTRL_CHECK_RULES
           SET TABLE_ID = p_table_id, CLASS_OBJ_VALIDATION_IND = 'N',
               ...
               CHECK_MESSAGE = p_message, SEVERITY_LEVEL = 'WARNING', REV_TEXT = c_rev_text
        ...
        ELSE
            ...
            VALUES
                ('CTRL_CHECK_RULES', v_id, p_name, 'Count(*)', p_table_id, 'N',
                 '(${FunctionFrozenValue}  = ${ConstBOOLEAN})', p_message, 'WARNING', c_rev_text);
        END IF;
...
-- VERIFY: expect 6 rows, all WARNING. (group linkage verified by the Check_Group script.)
SELECT r.CHECK_ID, r.CHECK_NAME, r.TABLE_ID, r.SEVERITY_LEVEL
