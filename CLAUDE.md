...
4. ⛔ **PROPOSED (owner sign-off pending) — on ANY blocker/error/park candidate, RUN, never eyeball, the
   ...
   **Exit 2 = STOP and read the hits; do NOT re-investigate.** Exit 0 = new ground, scan away (then write
   ...
   _Why this is proposed as a COMMAND and not a reminder: item 3 above already said "check KNOWN_ISSUES
   ...
   by an exit code. Reverted from PR #285 because I added it without asking; re-raised here on its own for
   your decision._
