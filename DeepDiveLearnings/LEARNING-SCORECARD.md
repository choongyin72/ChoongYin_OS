...
| N1 generalization → injection wells | ✅ BUILT + live 3/3 (2026-06-14): "Daily Water Injection Well Status" (IWEL_DAY_STATUS), same WR.0001 template, C4=ON_STREAM_HRS DB-verified, DB-restore-null self-clean; WR.0001 canary still green (shared DbVerify change safe). N1 now 3 screens (PWEL/STRM/IWEL) | **A** |
