...
| N1 generalization → injection wells | recon DONE 2026-06-14 (build-ready): "Daily Water Injection Well Status" (IWEL_DAY_STATUS), same WR.0001 template, C4=ON_STREAM_HRS DB-proven, non-iframed, scope AS2_Water Injection Manifold 1; self-clean fork documented | **B** |
