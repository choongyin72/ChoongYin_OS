...
- **BF_CODE:** CO.2081
- **Treeview:** Configuration > Assets > Transport_Objects > Pilot Boat
...
- **RF:** T3 `pageobjects/Configuration/Assets/Transport_Objects/pilot_boat_page.resource` (**label-driven**) + suite `tests/Configuration/Assets/Transport_Objects/pilot_boat_iud.robot`.
