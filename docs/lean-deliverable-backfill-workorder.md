...
| 5 | Complete | #595 Property, #596 Transport Zone, #597 Well Bore Interval, #598 Pilot, #599 Well Bore, #600 Lifting Account | Backfilled + merged 2026-08-28 (54-PR round). Zero automation files touched; provenance + sourced ticks verified per PR. _Row consolidated by the reviewer at merge - 54 parallel PRs each wrote partial log rows, leaving 22 duplicate/conflicting entries; rebuilt to one row per batch._ |
| 6 | Complete | #601 Payment Scheme, #602 Field Group, #603 Customer, #604 Country, #605 MMS Lease, #606 Licence, #607 Operator Lease | Backfilled + merged 2026-08-28 (54-PR round). Zero automation files touched; provenance + sourced ticks verified per PR. _Row consolidated by the reviewer at merge - 54 parallel PRs each wrote partial log rows, leaving 22 duplicate/conflicting entries; rebuilt to one row per batch._ |
| 7 | Complete | #608 State Lease, #609 Vendor, #610 Product Description, #611 Cost Object Mapping, #612 DOA Credit Limit, #613 Sales Order, #614 Product Group | Backfilled + merged 2026-08-28 (54-PR round). Zero automation files touched; provenance + sourced ticks verified per PR. _Row consolidated by the reviewer at merge - 54 parallel PRs each wrote partial log rows, leaving 22 duplicate/conflicting entries; rebuilt to one row per batch._ |
| 8 | Complete | #615 Royalty Owner, #616 Calendar Collection, #617 Royalty Depositor, #618 Unit Agreement, #619 Calendar, #620 Berth, #621 Account Mapping | Backfilled + merged 2026-08-28 (54-PR round). Zero automation files touched; provenance + sourced ticks verified per PR. _Row consolidated by the reviewer at merge - 54 parallel PRs each wrote partial log rows, leaving 22 duplicate/conflicting entries; rebuilt to one row per batch._ |
| 9 | Complete | #622 Blend, #623 Calculation Group Context, #624 Canal, #625 Calculation Context, #626 Inventory Area, #627 Meter Run, #628 Chemical Transport Tank | Backfilled + merged 2026-08-28 (54-PR round). Zero automation files touched; provenance + sourced ticks verified per PR. _Row consolidated by the reviewer at merge - 54 parallel PRs each wrote partial log rows, leaving 22 duplicate/conflicting entries; rebuilt to one row per batch._ |
| 10 | Complete | #629 Orifice Plate, #630 Reservoir Formation, #631 Reservoir Block, #632 Port, #633 Split Item Other, #634 Process Train, #635 Report Area | Backfilled + merged 2026-08-28 (54-PR round). Zero automation files touched; provenance + sourced ticks verified per PR. _Row consolidated by the reviewer at merge - 54 parallel PRs each wrote partial log rows, leaving 22 duplicate/conflicting entries; rebuilt to one row per batch._ |
| 11 | Complete | #636 Storage Flow, #637 Stream Item Category, #638 Data Extract Set, #639 Trailer, #640 Carrier, #641 Bank Account, #642 Deferment Group | Backfilled + merged 2026-08-28 (54-PR round). Zero automation files touched; provenance + sourced ticks verified per PR. _Row consolidated by the reviewer at merge - 54 parallel PRs each wrote partial log rows, leaving 22 duplicate/conflicting entries; rebuilt to one row per batch._ |
| 12 | Complete | #643 Chemical Product, #644 Report Context, #645 Document Template, #646 Product, #647 Target Mapping Configuration, #648 County | Backfilled + merged 2026-08-28 (54-PR round). Zero automation files touched; provenance + sourced ticks verified per PR. _Row consolidated by the reviewer at merge - 54 parallel PRs each wrote partial log rows, leaving 22 duplicate/conflicting entries; rebuilt to one row per batch._ |
