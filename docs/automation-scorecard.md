...
| Loading Arm (OV-GM, ) | OK Done 2026-07-30 - RF 4/4 pass + Playwright 8/8 via verify_screen.py (OVERALL PASS), DB-verified vs OV_LOADING_ARM (Name), self-clean; OV-GM gated-navigator; label-driven; Op PU first-available | see docs/ov-non-bank-targets.md |
