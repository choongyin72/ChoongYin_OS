...
| Royalty Objects | Unit Agreement (OV, plain) — 4/8 | ✅ Live 4/4 (2026-06-25) | 4th of 8 Royalty Objects screens; built via `gen_ov_iud_bundle.py` (Bank-family generator); `OV_UNIT_AGR` (view != slug); no shared-file edits; DB-verified + self-cleaning; stacked on PR #121 |
