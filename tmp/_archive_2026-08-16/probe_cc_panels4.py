#!/usr/bin/env python3
"""READ-ONLY: find the exact display label for location code TS5_DP_GP_GSP among Location Name's 230
options. Nothing saved."""
import os, sys
...
with sync_playwright() as p:
    ...
    matches = [o for o in opts if "gsp" in o.lower() or "ts5" in o.lower()]
    print(a("total options: %d; TS5/GSP matches: %s" % (len(opts), matches[:15])))
    br.close()
