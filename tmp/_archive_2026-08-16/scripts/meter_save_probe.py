...
with sync_playwright() as p:
    ...
    # complete the insert: code/name + Meter Type dd, then Save and capture the banner
    import time as _t
    page.fill('[id="tab:tabPanel:objectForm:form:G:0:R:0:C:1:in"]', 'AUTOTEST_MTRPROBE')
    page.fill('[id="tab:tabPanel:objectForm:form:G:0:R:1:C:1:in"]', 'Meter Probe')
    ...
    page.screenshot(path=r"c:/Projects/ChoongYin_OS/tmp/dispatching_recon/meter_save_probe.png", full_page=True)
    b.close()
